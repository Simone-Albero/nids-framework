...
class TransformerAutoencoder(BaseModule):
    ...
    __slots__ = ["embedding", "encoder", "decoder", "numeric_head", "categorical_head", "noise_factor"]

    def __init__(
        self, input_dim: int, model_dim: int = 128, num_heads: int = 2, num_layers: int = 4, ff_dim: int = 64,
        dropout: float = 0.1, noise_factor: float = 0.1, numeric_dim: Optional[int] = None,
        ...
        self.decoder = TransformerDecoder(model_dim, num_heads, num_layers, ff_dim, dropout)
